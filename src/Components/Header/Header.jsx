        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle" href="#" id="anotherDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Another Dropdown
                </a>
                <ul className="dropdown-menu" aria-labelledby="anotherDropdown">
