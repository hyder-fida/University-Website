    ...
    <div className="container my-5">
      <div className="row d-flex justify-content-between align-items-center">
        <div className="col-md-4">
          ...
          <ul className="footer-social-icone list-unstyled d-flex justify-content-between">
            <Link to="/contact">
              <li>
                <svg
        ...
        <div className="col-md-7 col-lg-6">
          <div className="d-row d-md-flex justify-content-between align-items-center">
            <div className="col-12 col-md-6 col-lg-5 mb-5 mt-4 my-md-0">
              <ul className="footer-navigator list-unstyled">
            ...
            <div className="col-12 col-md-6 col-lg-7">
              <ul className="list-unstyled mb-0">
                <li>
                  <p>Main Address - Awantipora Pulwama Srg. </p>
                </li>
                <li>
                  <p>Phone Number - 00424277899. </p>
                </li>
                <li>
                  <p>Email - iust@ac.in. </p>
                </li>
              </ul>
            </div>
          </div>
